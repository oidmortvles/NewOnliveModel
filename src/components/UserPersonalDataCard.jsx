  ...
  return (
    <section className='userPersonalDataCard'>  
                ...
                <aside className='updcDataShort'>
                    ...
                    <NavLink to={"favoritos"} className={({ isActive }) => (isActive ? 'updcShortItems activeUpcdShortItems' : 'updcShortItems')}>
                    ...
                    <NavLink to={"bonos"} className={({ isActive }) => (isActive ? 'updcShortItems activeUpcdShortItems' : 'updcShortItems')}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <NavLink to={"historial"} className={({ isActive }) => (isActive ? 'updcShortItems activeUpcdShortItems' : 'updcShortItems')}>                        
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
