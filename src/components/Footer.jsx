...
function Footer() {
  return (
    <footer>
        <header>
            <aside className='headerPart1'>
                <div className='nbLogo'></div>
                <section className='footerRedes'>

                    <h4>Seguinos en:</h4>

                    <div className='footerItemRedSocial'>
                        {/* INSTAGRAM */}
                        <a href="#!">
            ...
            <aside className='headerPart2'>
               <div className="footerSectionLegales">
                    <h4>Inscripción</h4>
                ...
                <div className="footerSectionLegales">
                    ...
                    <a href="!#">Credencial de Pago (CUR)</a>
                </div>


                <div className="footerSectionLegales">
                    <h4>Reglas sobre apuestas</h4>
                    <a href="!#">Política de cookies</a>
                    <a href="!#">Ruleta online</a>
                </div>     
            </aside>
        </header>

        <article>   
            <div className="footerArticleItem">
                <div className="footerIconPlace">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
                    </svg>
                    <h4>0-800-666-6006</h4>
                </div>
                <div className='footerArticletextBox'>                    
                    <p>Linea gratuita de orientación al jugador problematico</p>
                </div>
            </div>
            ...
            <div className="footerArticleItem">
                <div className="footerIconPlace">
                    <svg fill="currentColor" height="40" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" >
                        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                        <g id="SVGRepo_iconCarrier"><g id="group">
                ...
                <p>Autoexcluite haciendo <span><a href='!#'>click aqui</a></span></p>
            </div>
            ...
            <div className="footerArticleItem">
                ...
                <p>El Juego Compulsivo es perjudicial para vos y tu familia. Cuidate</p>                
            </div>
        </article>
