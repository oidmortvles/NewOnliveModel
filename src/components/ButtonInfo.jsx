...
function ButtonInfo({colorSet}) {

    let colorInfo;
    switch (colorSet) {
      case "Primary":
        colorInfo="buttonInfoPrimary";
        break;
  
      case "Secondary":
        colorInfo="buttonInfoSecondary";
        break;
  
      case "Action":
        colorInfo="buttonInfoAction";
        break;
        
      default:
        colorInfo="buttonInfo";
        break;
    }    

    const styleSetInfo = `${colorInfo}`;

  return (
    <button className={styleSetInfo}>
